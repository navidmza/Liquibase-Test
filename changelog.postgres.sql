...
--changeset SteveZ:5582471835439-8
CREATE TABLE SALES8 (ID BIGINT, ITEM VARCHAR(255), QUANTITY int, AMOUNT FLOAT, CONSTRAINT SALES_PK7 PRIMARY KEY (ID));
--rollback DROP TABLE SALES8;
